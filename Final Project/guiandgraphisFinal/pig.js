...
var blueMaterial = new THREE.MeshBasicMaterial( { color: offPink } );
var yellowMaterial = new THREE.MeshBasicMaterial( { color: ligntPink } );
var purpleMaterial = new THREE.MeshBasicMaterial( { color: darkPink } );
